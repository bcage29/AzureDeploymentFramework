...
var DC2PrivateIPAddress = ! contains(DeploymentInfo,'DNSServers') ? Global.DNSServers[1] : length(DeploymentInfo.DNSServers[1]) <= 3 ? '${networkId}.${DeploymentInfo.DNSServers[1]}' : DeploymentInfo.DNSServers[1]
var DNSServers = [
  DC1PrivateIPAddress
  DC2PrivateIPAddress
]
